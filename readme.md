...
- added command line handlers
	- done: missing for nature

- worthwhile having convert_and_prune or can we use convert manually and then parse the dict as normal ?  ? ? 
	- added a parameter for convert - by defaults it's executed
